const templateInfo = {
  ...
  WMSdevSecure: {
    customer: '精益生产物料管理系统--WMS管理系统',
    title: 'WMS管理系统',
    VUE_APP_BASE_API: 'https://192.168.1.7:9005/api/system',
    VUE_APP_BASE_API_WMS: 'https://192.168.1.7:9005/api/wms',
    VUE_APP_BASE_API_ACTIVITI: 'https://192.168.1.7:9005/api/flowable',
    buildFilesList: ['board', 'sys', 'wms'],
    board: {
      boardList: [
        {
