...
//   try {
//     const res = await fs.readFile('hello.txt', 'utf-8')
//     console.log('res: ', res)
//   } catch (error) {
...
// 重命名文件为Bilibili.txt
// fs.renameSync('hello.txt', 'Bilibili.txt')
// 新增一行：我是Erik，感谢您的点赞！
// fs.appendFileSync('Bilibili.txt', '\n我是Erik，感谢您的点赞！')

// 3、将文件复制到dir1/dir2下，同事创建目录dir1/dir3
// copyFile只能复制文件，并且copyFile没有copy好用。copyFile不能复制这个文件的权限跟修改时间等等
// copy既可以复制文件也可以复制文件夹
// fs.copySync('Bilibili.txt', 'dir1/dir2/Bilibili.txt')
// 将目录dir1的内容复制到dir4下
// fs.copySync('dir1', 'dir4/dir1')

// 4、删除目录dir1和dir4
// fsExtra.removeSync('dir1')

// 5、复制test目录到test2目录下
// fs.copySync('test', 'test2')
